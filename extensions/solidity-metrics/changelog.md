...
- new: metrics report for scopefile - [#23](https://github.com/ConsenSys/vscode-solidity-metrics/issues/23)
...
## v0.0.21
- fix: support multi-workspace environments - [#12](https://github.com/ConsenSys/vscode-solidity-metrics/issues/12)
...
## v0.0.18
- fix: exported metrics report does not render in browser - [#10](https://github.com/ConsenSys/vscode-solidity-metrics/issues/10)
...
## v0.0.15
- update: solidity-metrics ([Changelog](https://github.com/ConsenSys/solidity-metrics/releases/tag/v0.0.14)) - fixes [#9](https://github.com/ConsenSys/vscode-solidity-metrics/issues/9)
...
## v0.0.12
- fixed: report not rendering - [#6](https://github.com/ConsenSys/vscode-solidity-metrics/issues/6)
...
## v0.0.8
- Adopt VS Code's 'asWebviewUri' API - [#1](https://github.com/ConsenSys/vscode-solidity-metrics/issues/1)
