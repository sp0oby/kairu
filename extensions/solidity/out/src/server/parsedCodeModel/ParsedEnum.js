...
class ParsedEnum extends parsedCode_1.ParsedCode {
    ...
    toDocumentSymbol() {
        ...
        const enumSymbol = vscode_languageserver_1.DocumentSymbol.create(this.name, this.getSimpleInfo(), vscode_languageserver_1.SymbolKind.Enum, enumRange, enumRange);
        return enumSymbol;
    }
    getSimpleInfo() {
