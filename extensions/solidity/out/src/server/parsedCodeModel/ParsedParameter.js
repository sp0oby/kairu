...
class ParsedParameter extends ParsedVariable_1.ParsedVariable {
    ...
    toDocumentSymbolType(parameterType) {
        const name = this.name || 'Unnamed';
        const paramRange = this.getRange();
        return vscode_languageserver_1.DocumentSymbol.create(name, `${parameterType}: ${this.type.getSimpleInfo()}`, vscode_languageserver_1.SymbolKind.Variable, paramRange, paramRange);
    }
}
