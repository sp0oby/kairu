...
class ParsedStruct extends parsedCode_1.ParsedCode {
    ...
    toDocumentSymbol() {
        ...
        const structSymbol = vscode_languageserver_1.DocumentSymbol.create(name, this.getSimpleInfo(), vscode_languageserver_1.SymbolKind.Struct, structRange, structRange);
