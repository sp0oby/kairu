...
class ParsedDocument extends parsedCode_1.ParsedCode {
    ...
    toDocumentSymbol() {
        ...
        const documentSymbol = vscode_languageserver_1.DocumentSymbol.create(((_a = this.sourceDocument) === null || _a === void 0 ? void 0 : _a.absolutePath) || 'Document', 'Solidity Document', vscode_languageserver_1.SymbolKind.File, documentRange, documentRange);
