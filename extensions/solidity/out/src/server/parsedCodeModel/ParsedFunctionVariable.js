...
class ParsedFunctionVariable extends ParsedVariable_1.ParsedVariable {
    ...
    toDocumentSymbolType() {
        const name = this.name || 'Unnamed';
        const varRange = this.getRange();
        return vscode_languageserver_1.DocumentSymbol.create(name, `Variable: ${this.type.getSimpleInfo()}`, vscode_languageserver_1.SymbolKind.Variable, varRange, varRange);
    }
}
