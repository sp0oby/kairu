...
class ParsedFunction extends parsedCode_1.ParsedCode {
    ...
    toDocumentSymbol() {
        ...
        const functionSymbol = vscode_languageserver_1.DocumentSymbol.create(this.name || this.getParsedObjectType(), this.getSimpleInfo(), this.getSymbolKind(), functionRange, functionRange);
