...
class ParsedContract extends parsedCode_1.ParsedCode {
    ...
    toDocumentSymbol() {
        ...
        const contractSymbol = vscode_languageserver_1.DocumentSymbol.create(name, this.getContractTypeName(this.contractType), vscode_languageserver_1.SymbolKind.Class, // Use SymbolKind.Class for contracts, interfaces, or libraries
