...
class ParsedEvent extends parsedCode_1.ParsedCode {
    ...
    toDocumentSymbol() {
        ...
        const eventSymbol = vscode_languageserver_1.DocumentSymbol.create(this.name, this.getSimpleInfo(), vscode_languageserver_1.SymbolKind.Event, eventRange, eventRange);
