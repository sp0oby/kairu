...
exports.SolidityDocumentSymbolProvider = void 0;
...
class SolidityDocumentSymbolProvider {
     ...
     */
    provideDocumentSymbols(document, walker) {
        ...
        if (selectedDocument) {
            ...
            return (documentSymbol === null || documentSymbol === void 0 ? void 0 : documentSymbol.children) || [];
        }
        return undefined;
    }
}
exports.SolidityDocumentSymbolProvider = SolidityDocumentSymbolProvider;
//# sourceMappingURL=SolidityDocumentSymbolProvider.js.map