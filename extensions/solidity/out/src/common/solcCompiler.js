...
class SolcCompiler {
    ...
    compileSolidityDocumentAndGetDiagnosticErrors(filePath, documentText, packageDefaultDependenciesDirectory, packageDefaultDependenciesContractsDirectory, remappings, selectedCompiler = null, evmVersion = '', viaIR = false) {
        if (selectedCompiler == null) {
            selectedCompiler = this.selectedCompiler;
        }
