...
class SourceDocumentCollection {
    ...
    getDefaultSourceDocumentsForCompilation(optimizeCompilationRuns = 200, evmVersion = "", viaIR = false) {
    ...
    getDefaultSourceDocumentsForCompilationDiagnostics(evmVersion = "", viaIR = false) {
        const compilerOutputSelection = {
            '*': {
                '': [],
                '*': [],
    ...
    getSourceDocumentsForCompilation(optimizeCompilation, optimizeCompilationRuns, evmVersion = "", viaIR = false, outputSelection) {
