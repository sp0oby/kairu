...
class EtherscanContractDownloader {
    static isValidAddressMessage(address) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (vscode.window.activeTextEditor) {
                try {
                    ...
                    const selectedChain = yield vscode.window.showInputBox(inputBoxChain);
    ...
    static downloadContract(chain, address, projectPath, subfolder = 'chainContracts') {
        return __awaiter(this, void 0, void 0, function* () {
            const apiKey = settingsService_1.SettingsService.getExplorerEtherscanBasedApiKey();
