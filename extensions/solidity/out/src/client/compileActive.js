...
function compileActiveContract(compiler, overrideDefaultCompiler = null) {
    ...
    const viaIR = settingsService_1.SettingsService.getViaIR();
    ...
    return compiler.compile(contractsCollection.getDefaultSourceDocumentsForCompilation(compilationOptimisation, evmVersion, viaIR), diagnosticCollection, project.projectPackage.build_dir, project.projectPackage.absoluletPath, null, packagesPath, contract.absolutePath, overrideDefaultCompiler);
}
