...
## 0.0.15
- fix: typo in snippet `funcnonreentrant` [#25](https://github.com/tintinweb/vscode-vyper/issues/25)

## 0.0.14
- new: suppress compiler error/success popup boxes by default. can be re-enabled by setting `vyper.compile.verbose = true`
- update: snippets to fit vyper 0.3.x [#19](https://github.com/tintinweb/vscode-vyper/issues/19) - thanks @msugarm
- update: dependencies

## 0.0.13 - 0.0.12
- new: vscode.dev support (vscode web extension) [#12](https://github.com/tintinweb/vscode-vyper/issues/12)
  - Note: compiling vyper is not yet supported!
- update: updated snippets for vyper v0.3.x [#11](https://github.com/tintinweb/vscode-vyper/issues/11) - thanks @DataBeast-IT 🙌

## 0.0.11
- new: updated syntax to vyper v0.3.x [#9](https://github.com/tintinweb/vscode-vyper/issues/9) - thanks @DataBeast-IT 🙌

## 0.0.10
- fix: an issue where the compilation would fail on windows systems [#4](https://github.com/tintinweb/vscode-vyper/issues/4)
- update: disabled mythx.io trial code
- update: disabled signature helper (not yet implemented)
- update: quick code cleanup
- fix: allow workspace relative `vyper.command` [#3](https://github.com/tintinweb/vscode-vyper/issues/3)
