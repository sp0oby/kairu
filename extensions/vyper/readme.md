...
![img](https://github.com/tintinweb/vscode-vyper/raw/HEAD/images/icon.png)
...
* Quickly create `constructor`, `fallback` function, `methods`, `structs`, ... as you type. Select the snippet from the suggestion box. See [snippets/](https://github.com/tintinweb/vscode-vyper/blob/HEAD/snippets/) for a list of available snippets.
* start typing ...
...
* **A**: The extension executes the vyper compiler in a `/bin/sh` shell that may not have all the customizations you are using in your day-to-day shell/terminal. As a workaround, I suggest to set the setting:`vyper.command` to `arch -x86_64 vyper`. see [#18](https://github.com/tintinweb/vscode-vyper/issues/18)
...
see [CHANGELOG](https://github.com/tintinweb/vscode-vyper/blob/HEAD/CHANGELOG.md)
